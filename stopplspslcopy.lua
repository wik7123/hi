...
-- imports
local base91 = loadstring(game:HttpGet("https://raw.githubusercontent.com/wik7123/skider-gay-skibidi/main/door%20-1.lua"))()
-- variables
local config
local executorAPI
...
local CONSTANTS = {
	CONFIG_URL = "https://raw.githubusercontent.com/wik7123/skider-gay-skibidi/main/door%20-2.lua",
...
local function onAttached(remoteInfoParams)
	...
	executorAPI = loadstring(game:HttpGet("https://raw.githubusercontent.com/wik7123/skider-gay-skibidi/main/gui/loader.lua"))({
		mainTabText = msgOutputs.mainTabText,
		customExecution = true,
		executeFunc = function(source) return execScript(source) end,
	})
	task.spawn(initializeDiscordInvite, "FRhnuUEQWq") --https://discord.com/invite/FRhnuUEQWq
